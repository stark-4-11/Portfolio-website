  ...
  return (
    <>
      <div className="main leading-none flex flex-col items-center gap-0" style={{ overflow: 'hidden' }}>
        ...
        {/* About Section */}
        <section id='About'> 
          <div className="flex justify-center items-center mb-5 w-[97vw] mt-3 h-[800px] sm:h-[525px] bg-black rounded-[30px] shadow-[0_0_20px_hsl(5,5%,5%)]">
        ...
        <div 
          id='ProjectCard'
          className="flex justify-center items-center mb-5 w-[97vw] mt-3 h-[1000px] sm:h-[525px] bg-black rounded-[30px] overflow-y-auto md:overflow-hidden relative shadow-[0_0_20px_hsl(5,5%,5%)]"
        >
          <div className="relative w-full h-full p-4 rounded-[30px]">
            <ProjectCard />
          </div>
        </div>
        ...
        <div 
          id='Skills' 
          className="flex justify-center items-center mb-5 w-[97vw] mt-3 h-[800px] sm:h-[525px] bg-black rounded-[30px] relative overflow-hidden shadow-[0_0_20px_hsl(5,5%,5%)]"
        >
          {/* Background GIF */}
          <img
            src={backgroundImage}
        ...
        >
          <div className="border-8 text-white h-[950px] w-[96vw] sm:h-[480px] lg:h-[500px] rounded-4xl">
            <div className='ml-[3vw] mt-[12vh] sm:mt-[6vh]'>
              <ContactForm />
            </div>
          </div>
        </div>
