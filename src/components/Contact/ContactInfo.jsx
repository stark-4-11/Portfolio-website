...
const ContactInfo = () => {
  return (
    <div>
      <div className="text-white sm:mt-[-90px] p-6 space-y-10">
        <div>
        <p className="flex justify-center items-center text-white border-0 rounded-md p-2 mb-4 focus:ring-0 focus:outline-none font-[estile9] border-x-2">+91 9812445606</p>
        <br />
        <p className="flex justify-center items-center text-white border-0 rounded-md p-2 mb-4 focus:ring-0 focus:outline-none font-[estile9] border-x-2">imlakshaykhanna@gmail.com</p>

<br />
        <a 
      href="/Lakshay_khanna_CV.pdf"  
      download="Lakshy_Khanna_CV.pdf"
      className="bg-white px-6 py-3  flex items-center gap-2 hover:bg-gray-400 transition-all duration-300 text-black border-0 rounded-md p-2 mb-4 focus:ring-0 focus:outline-none font-[estile9] border-x-2"
    >
      <FaDownload />
      Download CV
    </a>
        ...
        {/* Social Icons */}
        <section className="flex justify-center items-center gap-6 h-20 w-80 text-white border-0 rounded-md font-[estile9] border-x-2">
      {/* Instagram Link */}
      <a
